...
namespace SpeechSynthesis
{
    internal static class SpeechService
    {
        ...
        private static MediaPlayer speechPlayer;
        ...
        //public static async Task SayWeatherforecast(RecognizedSpeech recognizedSpeech)
        //{
        ...
        //public static async Task SayWeatherToday()
        //{
        ...
        private static async Task sayAsync(string ssml)
        {
            ...
            stringBuilder.AppendLine(@"<break time='1000ms'/>");
