...
namespace SmartMirrorServer.RequestHandler.Sites
{
    internal static class Home
    {
        ...
        private static async Task<string> getWeatherforecastModul(Modules modules)
        {
            ...
            stringBuilder.Append($" <tr> <td> <label style=\"font-size: 1.5em;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{(int)result[0].MinTemp}</label> <label style=\"font-size: 1.5em;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{(int)result[0].MaxTemp}</label> </td> <td> <label style=\"font-size: 1.5em;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{(int)result[1].MinTemp}</label> <label style=\"font-size: 1.5em;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{(int)result[1].MaxTemp}</label> </td> <td> <label style=\"font-size: 1.5em;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{(int)result[2].MinTemp}</label> <label style=\"font-size: 1.5em;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{(int)result[2].MaxTemp}</label> </td> <td> <label style=\"font-size: 1.5em;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{(int)result[3].MinTemp}</label> <label style=\"font-size: 1.5em;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{(int)result[3].MaxTemp}</label> </td> <td> {(result.Count >= 5 ? $"<label style=\"font-size: 1.5em;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{(int)result[4].MinTemp}</label> <label style=\"font-size: 1.5em;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{(int)result[4].MaxTemp}</label>" : "")} </td> </tr>");
