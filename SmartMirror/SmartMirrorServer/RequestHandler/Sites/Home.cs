...
namespace SmartMirrorServer.RequestHandler.Sites
{
    internal static class Home
    {
        ...
        private static string getWeatherforecastModul(Module module)
        {
            ...
            stringBuilder.Append($" <tr> <td> <label style=\"font-size: 1.25em; color: grey;\">{result[0].Date:ddd}</label> </td> <td> <label style=\"font-size: 1.25em; color: grey;\">{result[1].Date:ddd}</label> </td> <td> <label style=\"font-size: 1.25em; color: grey;\">{result[2].Date:ddd}</label> </td> <td> <label style=\"font-size: 1.25em; color: grey;\">{result[3].Date:ddd}</label> </td> <td> <label style=\"font-size: 1.25em; color: grey;\">{result[4].Date:ddd}</label> </td> </tr>");

            stringBuilder.Append($" <tr> <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result[0].Icon)}\" alt=\"\" style=\"width: 80%;\"/> </td> <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result[1].Icon)}\" alt=\"\" style=\"width: 80%;\"/> </td> <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result[2].Icon)}\" alt=\"\" style=\"width: 80%;\"/> </td> <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result[3].Icon)}\" alt=\"\" style=\"width: 80%;\"/> </td> <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result[4].Icon)}\" alt=\"\" style=\"width: 80%;\"/> </td> </tr>");

            stringBuilder.Append($" <tr> <td> <label style=\"font-size: 1.25em;\">{Math.Round(result[0].Temperature, 1).ToString(CultureInfo.InvariantCulture)} °C</label> </td> <td> <label style=\"font-size: 1.25em;\">{Math.Round(result[1].Temperature, 1).ToString(CultureInfo.InvariantCulture)} °C</label> </td> <td> <label style=\"font-size: 1.25em;\">{Math.Round(result[2].Temperature, 1).ToString(CultureInfo.InvariantCulture)} °C</label> </td> <td> <label style=\"font-size: 1.25em;\">{Math.Round(result[3].Temperature, 1).ToString(CultureInfo.InvariantCulture)} °C</label> </td> <td> <label style=\"font-size: 1.25em;\">{Math.Round(result[4].Temperature, 1).ToString(CultureInfo.InvariantCulture)} °C</label> </td> </tr>");
        ...
        private static string getWeatherModul(Module module)
        {
            ...
            stringBuilder.Append($"<table style=\"width: 100%; height: 60%; table-layout: fixed; padding: 2.5%;\"> <col width=\"40%\"><col width=\"20%\"><col width=\"20%\"><col width=\"20%\"> <tr style=\"cursor: pointer;\" onclick=\"window.location='https://openweathermap.org/city/{result.Item.CityId}'\"> <td colspan=\"4\" style=\"font-size: 2.5em;\">{result.Item.Description}</td> </tr>");

            stringBuilder.Append($" <tr style=\"cursor: pointer;\" onclick=\"window.location='https://openweathermap.org/city/{result.Item.CityId}'\"> <td rowspan=\"2\"> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result.Item.Icon)}\" alt=\"\" style=\"width: 10em;\"/> </td> <td rowspan=\"2\" colspan=\"2\" style=\"text-align: left;\"> <label style=\"font-size: 8em; text-align: left;\">{Math.Round(result.Item.Temp, 1).ToString(CultureInfo.InvariantCulture)}</label> </td> <td style=\"text-align: left;\"> <label style=\"font-size: 1.5em; text-align: center; padding-left: 1%;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{Math.Round(result.Item.TempMax, 1).ToString(CultureInfo.InvariantCulture)}</label> </td> </tr>");

            stringBuilder.Append($" <tr style=\"cursor: pointer;\" onclick=\"window.location='https://openweathermap.org/city/{result.Item.CityId}'\"> <td style=\"text-align: left;\"> <label style=\"font-size: 1.5em; text-align: center; padding-left: 1%;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{Math.Round(result.Item.TempMin, 1).ToString(CultureInfo.InvariantCulture)}</label> </td> </tr>");

            stringBuilder.Append($" <tr style=\"cursor: pointer;\" onclick=\"window.location='https://openweathermap.org/city/{result.Item.CityId}'\"> <td style=\"font-size: 1em;\"><img src=\"location.png\" alt=\"\" style=\"height: 0.75em;\"/> {result.Item.City} </td> <td style=\"font-size: 1.75em; text-align: left;\"><img src=\"humidity.png\" alt=\"\" style=\"height: 0.75em;\"/> {result.Item.Humidity.ToString(CultureInfo.InvariantCulture)}  %</td> <td style=\"font-size: 1.75em; text-align: left;\"><img src=\"windspeed.png\" alt=\"\" style=\"height: 0.75em;\"/> {result.Item.WindSpeed.ToString(CultureInfo.InvariantCulture)} <label style=\"font-size: 0.4em;\"><div style=\"display: inline-block; text-align: center;\"> <span style=\"display: block; padding-top: 0.15em;\">m</span> <span style=\"display: none; padding-top: 0.15em;\">/</span> <span style=\"border-top: thin solid white; display: block;\">s</span> </div> </label> </td> </tr> </table>");
