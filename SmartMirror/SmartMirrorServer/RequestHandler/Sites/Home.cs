...
namespace SmartMirrorServer.RequestHandler.Sites
{
    internal static class Home
    {
        ...
        private static async Task<string> getWeatherforecastModul(Modules modules)
        {
            ...
            stringBuilder.Append(" <colgroup> <col span=\"1\" style=\"width: 20%;\"> <col span=\"1\" style=\"width: 20%;\"> <col span=\"1\" style=\"width: 20%;\"> <col span=\"1\" style=\"width: 20%;\"> <col span=\"1\" style=\"width: 20%;\"> </colgroup>");
            ...
            stringBuilder.Append($" <tr> <td> <label style=\"font-size: 1.5em; color: grey;\">{result[0].Date:ddd}</label> </td> <td> <label style=\"font-size: 1.5em; color: grey;\">{result[1].Date:ddd}</label> </td> <td> <label style=\"font-size: 1.5em; color: grey;\">{result[2].Date:ddd}</label> </td> <td> <label style=\"font-size: 1.5em; color: grey;\">{result[3].Date:ddd}</label> </td> {(result.Count >= 5 ? $" <td> <label style=\"font-size: 1.5em; color: grey;\">{result[4].Date:ddd}</label> </td>": "")} </tr>");

            stringBuilder.Append($" <tr> <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result[0].Icon)}\" alt=\"\" style=\"width: 100%;\"/> </td> <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result[1].Icon)}\" alt=\"\" style=\"width: 100%;\"/> </td> <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result[2].Icon)}\" alt=\"\" style=\"width: 100%;\"/> </td> <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result[3].Icon)}\" alt=\"\" style=\"width: 100%;\"/> </td> <td> {(result.Count >= 5 ? $"<img src=\"{WeatherHelperClass.ChooseWeatherIcon(result[4].Icon)}\" alt=\"\" style=\"width: 100%;\"/>" : "")} </td> </tr>");

            stringBuilder.Append($" <tr> <td> <label style=\"font-size: 1.5em;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[0].MinTemp.ToString(CultureInfo.InvariantCulture)}</label> <label style=\"font-size: 1.5em;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[0].MaxTemp.ToString(CultureInfo.InvariantCulture)}</label> </td> <td> <label style=\"font-size: 1.5em;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[1].MinTemp.ToString(CultureInfo.InvariantCulture)}</label> <label style=\"font-size: 1.5em;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[1].MaxTemp.ToString(CultureInfo.InvariantCulture)}</label> </td> <td> <label style=\"font-size: 1.5em;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[2].MinTemp.ToString(CultureInfo.InvariantCulture)}</label> <label style=\"font-size: 1.5em;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[2].MaxTemp.ToString(CultureInfo.InvariantCulture)}</label> </td> <td> <label style=\"font-size: 1.5em;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[3].MinTemp.ToString(CultureInfo.InvariantCulture)}</label> <label style=\"font-size: 1.5em;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[3].MaxTemp.ToString(CultureInfo.InvariantCulture)}</label> </td> <td> {(result.Count >= 5 ? $"<label style=\"font-size: 1.5em;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[4].MinTemp.ToString(CultureInfo.InvariantCulture)}</label> <label style=\"font-size: 1.5em;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[4].MaxTemp.ToString(CultureInfo.InvariantCulture)}</label>" : "")} </td> </tr>");
