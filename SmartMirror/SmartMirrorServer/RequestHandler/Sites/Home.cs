...
namespace SmartMirrorServer.RequestHandler.Sites
{
    internal static class Home
    {
        ...
        private static string getWeatherforecastModul(Module module)
        {
            ...
            stringBuilder.Append($" <tr> <td> <label style=\"font-size: 1.5em;\">{result[0].Temperature.ToString(CultureInfo.InvariantCulture)} °C</label> </td> <td> <label style=\"font-size: 1.5em;\">{result[1].Temperature.ToString(CultureInfo.InvariantCulture)} °C</label> </td> <td> <label style=\"font-size: 1.5em;\">{result[2].Temperature.ToString(CultureInfo.InvariantCulture)} °C</label> </td> <td> <label style=\"font-size: 1.5em;\">{result[3].Temperature.ToString(CultureInfo.InvariantCulture)} °C</label> </td> <td> <label style=\"font-size: 1.5em;\">{result[4].Temperature.ToString(CultureInfo.InvariantCulture)} °C</label> </td> </tr>");
