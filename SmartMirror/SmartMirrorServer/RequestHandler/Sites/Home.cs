...
namespace SmartMirrorServer.RequestHandler.Sites
{
    internal static class Home
    {
        ...
        private static string getWeatherModul(Module module)
        {
            ...
            stringBuilder.Append($"<table style=\"width: 100%; height: 60%; table-layout: fixed; padding: 2.5%;\"> <col width=\"40%\"><col width=\"auto\"><col width=\"30%\"> <tr style=\"cursor: pointer;\" onclick=\"window.location='https://openweathermap.org/city/{result.Item.CityId}'\"> <td colspan=\"3\" style=\"font-size: 2.5em;\">{result.Item.Description}</td> </tr>");

            stringBuilder.Append($" <tr style=\"cursor: pointer;\" onclick=\"window.location='https://openweathermap.org/city/{result.Item.CityId}'\"> <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(result.Item.Icon)}\" alt=\"\" style=\"width: 10em;\"/> </td> <td> <label style=\"font-size: 8em; text-align: left;\">{Math.Round(result.Item.Temp, 1).ToString(CultureInfo.InvariantCulture)}</label> </td> <td> <label style=\"font-size: 1.5em; display: block; text-align: center; vertical-align: top;\"><img src=\"hotsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{Math.Round(result.Item.TempMax, 1).ToString(CultureInfo.InvariantCulture)}</label> <label style=\"font-size: 1.5em; display: block; text-align: center; vertical-align: bottom;\"><img src=\"coldsmall.png\" alt=\"\" style=\"height: 0.75em;\"/>{Math.Round(result.Item.TempMin, 1).ToString(CultureInfo.InvariantCulture)}</label> </td> </tr>");

            stringBuilder.Append($" <tr style=\"cursor: pointer;\" onclick=\"window.location='https://openweathermap.org/city/{result.Item.CityId}'\"> <td style=\"font-size: 1.25em;\"><img src=\"location.png\" alt=\"\" style=\"height: 0.75em;\"/> {result.Item.City} </td> <td style=\"font-size: 1.75em;\"><img src=\"humidity.png\" alt=\"\" style=\"height: 0.75em;\"/> {result.Item.Humidity.ToString(CultureInfo.InvariantCulture)}  %</td> <td style=\"font-size: 1.75em; text-align: center;\"><img src=\"windspeed.png\" alt=\"\" style=\"height: 0.75em;\"/> {result.Item.WindSpeed.ToString(CultureInfo.InvariantCulture)} <label style=\"font-size: 0.4em;\"><div style=\"display: inline-block; text-align: center;\"> <span style=\"display: block; padding-top: 0.15em;\">m</span> <span style=\"display: none; padding-top: 0.15em;\">/</span> <span style=\"border-top: thin solid white; display: block;\">s</span> </div> </label> </td> </tr> </table>");
