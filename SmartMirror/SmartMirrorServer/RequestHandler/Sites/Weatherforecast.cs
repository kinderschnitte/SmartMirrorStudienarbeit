...
namespace SmartMirrorServer.RequestHandler.Sites
{
    internal static class Weatherforecast
    {
        ...
        private static string getForecastString()
        {
            ...
            forecastString.Append($" <tr style=\"cursor: pointer;\" onclick=\"window.location='https://openweathermap.org/city/{result[0][0].CityId}'\"> <td colspan=\"16\" style=\"font-size: 2.25em; text-align: left; padding-top: 1%; padding-bottom: 0.5%; color: grey;\">5 Tages Wettervorhersage</td> </tr>");
