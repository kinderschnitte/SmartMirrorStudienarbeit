...
namespace SmartMirrorServer.RequestHandler.Sites
{
    internal static class Weatherforecast
    {
        ...
        private static string getForecastString()
        {
            ...
            forecastString.Append(" <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\"> <col width=\"6.25%;\">");
            forecastString.Append($" <tr style=\"cursor: pointer;\" onclick=\"window.location='https://openweathermap.org/city/{result[0][0].CityId}'\"> <td colspan=\"16\" style=\"font-size: 1em; text-align: right;\"> <img src=\"location.png\" alt=\"\" style=\"height: 0.75em;\"/>{result[0][0].City}</td> </tr>");
            ...
            foreach (List<FiveDaysForecastResult> fiveDaysForecastResults in result)
            {
                ...
                forecastString.Append($" <tr style=\"cursor: pointer;\" onclick=\"window.location='https://openweathermap.org/city/{fiveDaysForecastResults[0].CityId}'\"> <td colspan=\"16\" style=\"font-size: 1.75em; color: grey; text-align: left; padding-top: 1.5%;\">{day}</td> </tr>");

                forecastString.Append($" <tr style=\"cursor: pointer; font-size: 1em; padding-top: 1.5%;\" onclick=\"window.location='https://openweathermap.org/city/{fiveDaysForecastResults[0].CityId}'\">");
                forecastString.Append($" <td colspan=\"2\">{(listCount > 0 ? fiveDaysForecastResults[0].Date.ToString("t") : "")}</td>");
                forecastString.Append($" <td colspan=\"2\">{(listCount > 1 ? fiveDaysForecastResults[1].Date.ToString("t") : "")}</td>");
                forecastString.Append($" <td colspan=\"2\">{(listCount > 2 ? fiveDaysForecastResults[2].Date.ToString("t") : "")}</td>");
                forecastString.Append($" <td colspan=\"2\">{(listCount > 3 ? fiveDaysForecastResults[3].Date.ToString("t") : "")}</td>");
                forecastString.Append($" <td colspan=\"2\">{(listCount > 4 ? fiveDaysForecastResults[4].Date.ToString("t") : "")}</td>");
                forecastString.Append($" <td colspan=\"2\">{(listCount > 5 ? fiveDaysForecastResults[5].Date.ToString("t") : "")}</td>");
                forecastString.Append($" <td colspan=\"2\">{(listCount > 6 ? fiveDaysForecastResults[6].Date.ToString("t") : "")}</td>");
                forecastString.Append($" <td colspan=\"2\">{(listCount > 7 ? fiveDaysForecastResults[7].Date.ToString("t") : "")}</td>");
                forecastString.Append(" </tr>");

                forecastString.Append($" <tr style=\"cursor: pointer; font-size: 1em;\" onclick=\"window.location='https://openweathermap.org/city/{fiveDaysForecastResults[0].CityId}'\">");
                ...
                //    forecastString.Append($" <td> <img src=\"{WeatherHelperClass.ChooseWeatherIcon(fiveDaysForecastResult.Icon)}\" alt=\"\" style=\"width: 100%; margin: auto;\"/> </td>");
